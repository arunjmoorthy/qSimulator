...
def index(request):
    if request.method == 'POST':
        ...
        if error_plot == 'on':
            ...
            error_plot = False
            result = streamnocheck(int(random_paulis), int(physical_qubits))
        Input.objects.create(random_paulis=random_paulis, physical_qubits=physical_qubits, error_plot=error_plot)
